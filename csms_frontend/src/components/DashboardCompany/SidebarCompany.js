...
const SidebarCompany = () => {
    return (
         <div className="col-md-3 col-lg-2 sidebar-offcanvas pl-0" id="sidebar" role="navigation" style={{backgroundColor:"#e9ecef"}}>
            ...
            <li className="nav-item mb-2 mt-3"><a className="nav-link text-secondary" href="#"><h5>Company</h5></a></li>
                ...
                <li className="nav-item mb-2"><a className="nav-link text-secondary" href="/login" onClick={()=>{localStorage.removeItem("company")}}><i className="far fa-folder font-weight-bold"></i> <span className="ml-3">Logout</span></a></li>
            </ul>
       </div>
    )
}
